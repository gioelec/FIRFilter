...
This structure requires N memory locations for storing previous inputs and in terms of complexity it does N+1 multiplications and  N additions.  For building this structure we simply use the definition: $$ y[n]=\sum_{i=0}^{N}c{_{i}}\cdot x[n-i]$$
\begin{figure}[H]
    \centering
